...
const ReportFoundItemModal = ({ onClose, onSuccess }) => {
    ...
    <div className="report-modal-overlay">
      <div className="report-modal-container">
        <div className="report-modal-header">
          <img src={reportFoundIcon} alt="report icon" className="report-modal-header-icon" />
          <div className="report-modal-header-content">
            ...
            <div className="report-modal-subtitle-row">
              ...
              <p className="report-modal-subtitle-text">Help the community reunite with lost items.</p>
            </div>
          </div>
